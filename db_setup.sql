-- ============================================================
--  Tavari Egypt — Full Database Setup  (idempotent, re-runnable)
--  Run once in Supabase -> SQL Editor. Safe to run again.
-- ============================================================

-- 1) TABLES (base schema; skipped if they already exist)
...
alter table public.gallery add column if not exists destination text;
...
-- 4) ANONYMOUS INSERT POLICIES (forms only — no select/update/delete, protects PII)
